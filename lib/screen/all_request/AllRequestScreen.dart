...
class _AllRequestState extends State<AllRequest> {
  ...
  bool _isShown = true;
  void _deleteState(BuildContext context,Function onConfirm,Function onCancel) {
    showDialog(
        context: context,
                      ...
                      child: ListTile(
                        ...
                        trailing: Column(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap:
                              _isShown==true ? ()=>_deleteState(context,
                                      (){
                                    DeleteRequest().deleteRequest(allRequestController.listRequest[index].sId!);
