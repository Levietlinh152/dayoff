...
class DetailPmProject extends StatefulWidget {
  DetailPmProject({Key? key, required this.project}) : super(key: key);
  late PmProjectModel project;

  @override
  State<DetailPmProject> createState() => _DetailPmProjectState();
}

class _DetailPmProjectState extends State<DetailPmProject> {
  ...
  PmProjectController pmProjectController = Get.find();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const CustomText(text: "PM PROJECT",),
      ),
      body: Padding(
