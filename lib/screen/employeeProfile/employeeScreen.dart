                ...
                children: [
                  ...
                  RoundedInputField(
                    textfielController: fullnameController
                      ..text = profileController.user.value.fullName.toString(),
                    hintText: "fullName",
                    onChanged: (value) {},
                  ),
                  RoundedInputField(
                      textfielController: nicknameController
                        ..text = profileController.user.value.nickName.toString(),
                      hintText: "nickName",
                      onChanged: (value) {},
                      icon: Icons.drive_file_rename_outline),
                  RoundedInputField(
                    textfielController: emailController
                      ..text = profileController.user.value.email.toString(),
                    hintText: "email",
                    icon: Icons.email,
                    onChanged: (value) {},
                  ),
                  RoundedInputField(
                    textfielController: citizenIdController
                      ..text = profileController.user.value.citizenID.toString(),
                    hintText: "cityzenId",
                    onChanged: (value) {},
                  ...
                  RoundedButton(
                      ...
                      press: () {
                        ...
                        controller.upDateUser(
                            profileController.user.value.sId!, allUser);
                      })
                ],
              ),
            ),
