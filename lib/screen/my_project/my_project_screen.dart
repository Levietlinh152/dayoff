...
import 'package:day_offf_app/screen/my_project/controller/my_project_controller.dart';
import 'package:day_offf_app/screen/user_project/user_project_screen.dart';
              ...
              itemBuilder: (BuildContext context, int index) {
                return Card(
                    ...
                    child: Container(
                      ...
                      child: InkWell(
                        onTap: () {
                           Get.to(UserProjectScreen(project: controller.listProject[index],));
                        },
                        child: ListTile(
                          leading: const Icon(
                            Icons.task,
