...
MyRequestController controller = Get.find();
  ...
  Widget build(BuildContext context) {
                                ...
                                children: [
                                  Container(
                                    decoration:  BoxDecoration(
                                       color: controller.stateColor(controller.myRequest[index].state!),
                                        borderRadius:
    ...
    Expanded(
    flex: 1,
    child: RoundedButton(text: "Request leave", press: (){Get.to(const RequestDayOff());}) ),
    ]
    );
