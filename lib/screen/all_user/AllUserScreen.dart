                ...
                itemBuilder: (BuildContext context, int index) {
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      title: CustomText(
                        text: '${controller.futureStudent[index].fullName}',
                      ),
                      subtitle: Column(
                          ...
                          children: [
                            CustomText(
                              text:
                                  'Username: ${controller.futureStudent[index].username}',
                              color: Colors.grey,
                            ),
                            CustomText(
                              text:
                                  'Level : ${controller.futureStudent[index].level}',
                              color: Colors.grey,
                            ),
                          ]),
                      trailing: CustomText(
                          text: "${controller.futureStudent[index].roles}"),
                      onTap: () {
                        Get.to(DetailUser(
                          user: controller.futureStudent[index],
                        ));
                      },
                    ),
                  );
